    ...
    var body: some View {
        VStack{
            ...
            VStack(alignment: .leading ){
                Text("Nome do Time:")
                HStack{
                    TextField("", text: $viewModel.description, prompt: Text("Digite o nome").foregroundColor(.white))
                ...
                Text("Descrição:")
                HStack{
                    TextField("", text: $viewModel.name, prompt: Text("Escreva a descrição").foregroundColor(.white))
                        .autocapitalization(.none)
                        .foregroundColor(.white)
                        .padding(.leading, 20)
                }
